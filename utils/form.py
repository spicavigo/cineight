...
from utils.field_templates import DEFAULT_TEMPLATE

class LZModelForm(ModelForm):
    ...
    def as_lz(self, state = 'enabled'):
        return self.html_output(DEFAULT_TEMPLATE, u'%s', '', u' %s', False, state)
    def as_lz_enabled(self):
        return self.as_lz(state = 'enabled')
                                
    def as_lz_disabled(self):
        return self.as_lz(state = 'disabled')

class LZForm(Form):
    def __init__(self, *args, **kwargs):
        self.id=self.__class__.__name__
        super(LZForm, self).__init__(*args, **kwargs)
